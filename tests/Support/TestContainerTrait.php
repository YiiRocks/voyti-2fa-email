...
trait TestContainerTrait
{
    ...
    protected function createTestContainer(array $overrides = []): ContainerInterface
    {
        ...
        $definitions = array_merge(
            ...
            (static fn(array $params): array => require $emailPath . '/config/di.php')($params),
        );
        ...
        $definitions = array_merge($definitions, [
            ...
            TranslatorInterface::class => (static function () use ($corePath, $twoFaPath, $emailPath, $validatorCategorySource): TranslatorInterface {
                ...
                $translator->addCategorySources(
                    ...
                    new CategorySource('voyti-2fa-email', new MessageSource($emailPath . '/resources/messages'), new SimpleMessageFormatter()),
